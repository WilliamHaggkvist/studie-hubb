...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StudyOS – din studieproduktivitetsapp" },
      { name: "description", content: "Notion-liknande arbetsyta för dina högskolestudier: sidor, kurser, uppgifter, kalender och tidsstatistik i en mörk, minimalistisk design." },
      { name: "theme-color", content: "#0F0F12" },
      { property: "og:title", content: "StudyOS" },
      { property: "og:description", content: "Din personliga arbetsyta för studier." },
