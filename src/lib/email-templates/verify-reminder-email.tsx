...
const codeContainer = { background: '#f1f5f9', borderRadius: '8px', padding: '16px', textAlign: 'center' as const, margin: '20px 0' }
const codeStyle = { fontSize: '32px', fontWeight: 700, letterSpacing: '8px', color: '#1e293b', margin: 0 }
