...
async function setAllDeadlines() {
  ...
  const due_at = "2026-10-23T23:59:00.000Z";
  ...
  if (error) {
    ...
    console.log(`Updated deadlines for ${data.length} tasks in CK105V to 23/10 23:59!`);
    data.forEach(t => console.log(`- ${t.title} (${t.task_type}): ${t.due_at}`));
  }
}
